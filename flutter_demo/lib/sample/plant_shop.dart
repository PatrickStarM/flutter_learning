...
class PlantShop extends StatelessWidget {
  ...
  Widget _centerBuild() {
    ...
    var list = [
      Plant(
          image: 'images/plant1.jpg', title: '君子兰', country: '中国', price: 440),
      Plant(image: 'images/plant2.jpg', title: '当归', country: '中国', price: 330),
      Plant(
          image: 'images/plant3.jpg', title: '萨曼莎', country: '俄罗斯', price: 220),
    ];
    var images = [
      'images/plant1.jpg',
      'images/plant2.jpg',
