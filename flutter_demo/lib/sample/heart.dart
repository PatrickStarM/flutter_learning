...
class Heart extends StatefulWidget {
  ...
  @override
  State<Heart> createState() => _DemoPaeState();
}

class _DemoPaeState extends State<Heart> {
  @override
  ...
  SliverAppBar _buildSliverAppBar() {
    return SliverAppBar(
      backgroundColor: Colors.blue.withAlpha(88),
